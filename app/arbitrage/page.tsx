...
export default function arbitragedetectorPage() {
  return (
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold">Arbitrage Detector</h1>
          <p className="text-muted-foreground mt-2">Find price differences across exchanges</p>
        </div>
      ...
      <div className="grid gap-4">
        <Card className="p-6">
          ...
          <div className="space-y-2">
            <p><strong>Feature ID:</strong> arbitrage-detector</p>
