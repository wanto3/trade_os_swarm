        ...
        <div style={{ backgroundColor: '#1a1a1a', border: '1px solid #333', borderRadius: '12px', padding: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {signals.map((signal) => {
              ...
              const bgColor = isBullish ? 'rgba(34, 197, 94, 0.15)' : isBearish ? 'rgba(239, 68, 68, 0.15)' : '#2a2a2a'
                ...
                <div key={signal.symbol} style={{ backgroundColor: bgColor, border: `1px solid ${borderColor}`, borderRadius: '8px', padding: '0.75rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                    ...
                    <div>
                      ...
                      <span style={{ marginLeft: '0.5rem', fontSize: '0.7rem', padding: '2px 6px', borderRadius: '4px', backgroundColor: '#1a1a1a', color: actionColor, border: `1px solid ${borderColor}` }}>
                        {signal.action}
                      </span>
                    </div>
                  </div>
